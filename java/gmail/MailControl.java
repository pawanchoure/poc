...
public class MailControl {
    ...
    public final void init() {
        ...
        this.username="pawanchoure";
        this.password="Chandrakala@011014";
        ...
        if (properties != null) {
            ...
            URLName urln = new URLName(properties.getProperty("protocal"), properties.getProperty("host"), port, null, "pawanchoure", "Chandrakala@011014");
