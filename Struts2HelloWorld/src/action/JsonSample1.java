...
import org.apache.struts2.convention.annotation.Action;
public class JsonSample1 extends ActionSupport {
  ...
  // @Actions({ @Action(value = "jsonsample2", results = { @Result(name = "success",location="/form-doubleselect.jsp") }) })
  //  @Action(value="/jsonsample", results={ @Result(name="SUCCESS",type = "json")})
